 ...
 * templates and computed properties automatically re-evaluate whenever the flag
 * set changes (e.g. after a remote refresh or a test-driven
...
export function useFeatureFlag(flags: FeatureFlags, key: string, fallback = false): ComputedRef<boolean> {
    ...
    return computed(() => {
        // Read tick to subscribe this computed to flag-set change
        // notifications.
        tick.value;
