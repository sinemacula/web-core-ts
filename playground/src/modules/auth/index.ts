 ...
 * anything from the auth module. All cross-module imports must go through here;
 * deep paths inside `src/modules/auth/**` are module-internal and must not be
 * referenced from outside this module. The generic session machinery (store,
 * guards, authorization, redirect handling) lives in the kernel session module
